...
export const shadowSlice = createSlice({
    ...
    reducers: {
        removeShadow: (state, action) => {
            ...
            //faire comme dans Fruity ???
            // if(shadowIndexToRemove) {
            //     state = state.filter(shadow => shadow.id !== action.payload)
            // }
